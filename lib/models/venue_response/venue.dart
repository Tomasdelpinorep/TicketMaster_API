...
class Venue {
	...
	factory Venue.fromVenueResponse(Map<String, dynamic> data) => Venue(
				...
				aliases: data['aliases'] as List<String>?,
				...
				country: data['country'] == null
						? null
						: Country.fromVenueResponse(data['country'] as Map<String, dynamic>),
				address: data['address'] == null
						? null
						: Address.fromVenueResponse(data['address'] as Map<String, dynamic>),
				location: data['location'] == null
						? null
						: Location.fromVenueResponse(data['location'] as Map<String, dynamic>),
				...
				boxOfficeInfo: data['boxOfficeInfo'] == null
						? null
						: BoxOfficeInfo.fromVenueResponse(data['boxOfficeInfo'] as Map<String, dynamic>),
				...
				generalInfo: data['generalInfo'] == null
						? null
						: GeneralInfo.fromVenueResponse(data['generalInfo'] as Map<String, dynamic>),
				upcomingEvents: data['upcomingEvents'] == null
						? null
						: UpcomingEvents.fromVenueResponse(data['upcomingEvents'] as Map<String, dynamic>),
				ada: data['ada'] == null
						? null
